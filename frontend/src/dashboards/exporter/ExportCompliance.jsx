    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal-box">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <div>
            <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: 20, fontWeight: 800, color: "#0f172a" }}>📑 Add Compliance Document</div>
    ...
    <>
      ...
      {(renewalDue > 0 || expired > 0) && !loading && (
        <div style={{ marginBottom: 20, display: "flex", gap: 10, flexWrap: "wrap" }}>
          {renewalDue > 0 && (
            <div style={{ flex: 1, minWidth: 200, padding: "12px 16px", borderRadius: 12, background: "rgba(251,191,36,0.08)", border: "1px solid rgba(251,191,36,0.25)", color: "#b45309", fontWeight: 700, fontSize: 13 }}>
              ⚠️ {renewalDue} document{renewalDue > 1 ? "s" : ""} due for renewal
            </div>
          )}
          {expired > 0 && (
            <div style={{ flex: 1, minWidth: 200, padding: "12px 16px", borderRadius: 12, background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)", color: "#dc2626", fontWeight: 700, fontSize: 13 }}>
              ...
              <div key={doc._id} className="card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", gap: 12 }}>
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  ...
                  {deleteConfId === doc._id ? (
                    ...
                    <button className="btn-ghost" style={{ flex: 1, justifyContent: "center", fontSize: 11, color: "#dc2626", borderColor: "rgba(239,68,68,0.2)" }} onClick={() => setDeleteConfId(doc._id)}>
                      🗑 Delete
                    </button>
                  )}
                </div>
