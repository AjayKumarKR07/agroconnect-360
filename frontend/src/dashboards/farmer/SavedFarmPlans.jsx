    ...
    <>
      ...
      <div className="pg-head">
        <div>
          ...
          <h1 className="pg-title">💾 Saved Farm Plans</h1>
          <p className="pg-sub">Your previously generated and saved Smart Farm Plans.</p>
        </div>
        <Link to="/farmer/smart-farm-planner" className="btn-green">🌾 New Plan</Link>
      </div>
          ...
          <div className="sp-grid">
            {plans.map(plan => (
              <div key={plan._id} className="sp-card">
                ...
                <div className="sp-crop">🌾 {plan.topCrop || "—"}</div>
            ...
            <div className="sp-detail-wrap">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  <button className="btn-green" style={{ fontSize: 12 }} onClick={() => printPlan(selected)}>🖨️ Download PDF</button>
              ...
              <div className="sp-section">
                <div className="sp-section-title">🏆 Crop Recommendations</div>
                {(selected.recommendations || []).slice(0, 5).map((rec, i) => {
                  const RANKS = ["🥇", "🥈", "🥉", "4️⃣", "5️⃣"];
                  return (
                    <div key={i} className="sp-rec-row">
                      <span className="sp-rank">{RANKS[i]}</span>
                      <div style={{ flex: 1 }}>
              ...
              <div className="sp-section" style={{ marginTop: 16 }}>
                <div className="sp-section-title">📋 Farm Input at Time of Plan</div>
