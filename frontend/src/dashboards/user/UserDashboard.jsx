...
const DS_USER = `
  ...
  .pg-title{font-family:'Space Grotesk',sans-serif;font-size:clamp(22px,3vw,30px);font-weight:800;color:#fff;line-height:1.2;letter-spacing:-0.02em;}
  ...
  .ud-stat-icon{font-size:24px;margin-bottom:10px;}
  .ud-stat-val{font-family:'Space Grotesk',sans-serif;font-size:30px;font-weight:800;color:#fff;}
  ...
  .card-title{font-family:'Space Grotesk',sans-serif;font-size:17px;font-weight:800;color:#fff;}
  ...
  .btn-cyan{display:inline-flex;align-items:center;gap:8px;padding:10px 20px;border-radius:12px;background:linear-gradient(135deg,#0284c7,#0ea5e9);color:#fff;font-weight:700;font-size:14px;border:none;cursor:pointer;text-decoration:none;font-family:'Inter',sans-serif;transition:opacity 0.2s,transform 0.2s;box-shadow:0 6px 20px rgba(14,165,233,0.3);}
...
export default function UserDashboard() {
  ...
  const statusBadge = (s) => {
    const map = {
      ...
      confirmed: { bg: "rgba(14,165,233,0.12)",  color: "#38bdf8", label: "✅ Confirmed" },
  ...
  const quickLinks = [
    { emoji: "🛒", label: "Browse",        to: "/user/browse",        color: "#0ea5e9" },
    { emoji: "📦", label: "Track Orders",  to: "/user/orders",        color: "#a78bfa" },
    { emoji: "❤️", label: "Wishlist",      to: "/user/wishlist",      color: "#f43f5e" },
  ...
  const statCards = [
    { icon: "📦", label: "Total Orders",  value: stats.totalOrders,    color: "#38bdf8" },
    { icon: "⏳", label: "Active Orders", value: stats.pendingOrders,   color: "#fbbf24" },
    { icon: "✅", label: "Delivered",     value: stats.deliveredOrders, color: "#4ade80" },
    { icon: "💰", label: "Total Spent",   value: `₹${Number(stats.totalSpent).toLocaleString("en-IN")}`, color: "#0ea5e9" },
  ];
        ...
        <>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 20, marginBottom: 24, alignItems: "start" }}>
            ...
            <div className="card">
              ...
              <div style={{ marginTop: 18, padding: "14px 16px", background: "rgba(14,165,233,0.06)", borderRadius: 12, border: "1px solid rgba(14,165,233,0.14)" }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: "#38bdf8", marginBottom: 6 }}>💡 Buyer Tips</div>
          ...
          {featured.length > 0 && (
            <div className="card">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                <div>
                  <div className="card-title">🌟 Fresh Arrivals from Farmers</div>
                ...
                {featured.map(c => (
                  <div key={c._id} className="feat-card">
                    ...
                    <div style={{ padding: "12px 14px" }}>
                      <div style={{ fontWeight: 800, color: "#fff", fontSize: 14, marginBottom: 2 }}>{c.name}</div>
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                        ...
                        <span style={{ fontSize: 10, padding: "2px 7px", borderRadius: 5, background: "rgba(34,197,94,0.1)", color: "#4ade80", fontWeight: 700 }}>🌿 FRESH</span>
                      </div>
                      <button
                        onClick={() => addToCart(c)}
                        style={{
