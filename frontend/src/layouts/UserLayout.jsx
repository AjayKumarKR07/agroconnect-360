...
import {
  LayoutDashboard, Search, Package, Heart, ShoppingCart, Archive,
  MessageSquare, Bell, Bot, User, ShoppingBag,
...
export default function UserLayout() {
  ...
  const nav = [
    { icon: LayoutDashboard, name: "Home",         path: "/user/dashboard" },
    { icon: Search,          name: "Browse",       path: "/user/browse" },
    { icon: Package,         name: "My Orders",    path: "/user/orders" },
    { icon: Heart,           name: "Wishlist",     path: "/user/wishlist" },
    { icon: ShoppingCart,    name: "Cart",         path: "/user/cart" },
    { icon: Archive,         name: "Subscriptions",path: "/user/subscriptions" },
    { icon: MessageSquare,   name: "Inquiries",    path: "/user/inquiries" },
    { icon: Bell,            name: "Alerts",       path: "/user/alerts" },
    { icon: Bot,             name: "AI Assistant", path: "/user/assistant" },
    { icon: User,            name: "Profile",      path: "/user/profile" },
  ];
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ul-brand-role {
          ...
          letter-spacing:0.08em; color:#0369a1; text-transform:uppercase;
        ...
        .ul-switch-role:hover { background:#bae6fd; }
        ...
        .ul-topbar-role-btn:hover { background:#bae6fd; }
      ...
      <div className="ul-wrap">
        <aside className={`ul-sidebar ${collapsed ? "collapsed" : ""}`}>
          <div className="ul-head">
            <div className="ul-logo"><ShoppingBag size={17} color="#ffffff" strokeWidth={2} /></div>
            {!collapsed && (
              <div>
            ...
            <div className="ul-user">
              ...
              {!collapsed && (
                <div style={{ overflow: "hidden", flex: 1 }}>
                  ...
                  <div className="ul-user-role">Consumer / Buyer</div>
                </div>
              )}
            </div>
            <button
        ...
        <div className={`ul-main ${collapsed ? "collapsed" : ""}`}>
          <header className="ul-topbar">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              {/* Cart badge */}
              <Link to="/user/cart" style={{ position: "relative", textDecoration: "none", width: 36, height: 36, borderRadius: 8, background: "#f8fafc", border: "1px solid #e2e8f0", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <ShoppingCart size={16} strokeWidth={1.75} color="#0284c7" />
                {cartCount > 0 && (
                  <span style={{ position: "absolute", top: -5, right: -5, width: 18, height: 18, borderRadius: "50%", background: "#0284c7", color: "#0f172a", fontSize: 10, fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center" }}>{cartCount}</span>
                )}
              </Link>
